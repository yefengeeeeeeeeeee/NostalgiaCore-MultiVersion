...
class Player{
	...
	public function handleDataPacket(RakNetDataPacket $packet)
    {
        ...
        if ($this->PROTOCOL >= ProtocolInfo7::CURRENT_PROTOCOL_5 && $this->PROTOCOL < ProtocolInfo9::CURRENT_PROTOCOL_9) {
            switch ($packet->pid()) {
                case 0x01:
                    break;
        ...
        }elseif ($this->PROTOCOL >= ProtocolInfo9::CURRENT_PROTOCOL_9 && $this->PROTOCOL < ProtocolInfo12::CURRENT_PROTOCOL_12){
            switch($packet->pid()){
                case 0x01:
                    break;
		...
		}elseif($this->PROTOCOL >= ProtocolInfo12::CURRENT_PROTOCOL_12 && $this->PROTOCOL < ProtocolInfo::CURRENT_PROTOCOL){
            switch($packet->pid()){
                case 0x01:
                    break;
