...
class VanillaGenerator implements LevelGenerator {
	 ...
	 */
	private $upperInterpolationNoise;
	private $lowerInterpolationNoise;
	private $interpolationNoise;
	private $beachNoise;
	private $surfaceDepthNoise;
	private $biomeNoise;
	private $depthNoise;
	private $treeNoise;
	/**
	...
	private $biomeNoises;
	private $depthNoises;
	private $interpolationNoises;
	private $upperInterpolationNoises;
	private $lowerInterpolationNoises;
	private $biomes;
	private $heights;
	private $sandNoises;
	private $gravelNoises;
	private $surfaceDepthNoises;
	/**
	 * @var BiomeSource
	 */
	private $biomeSource;
	...
	public function populateChunk($chunkX, $chunkZ) {
		...
		} elseif($biome == Biome::$rainForest) {
			$treesAmount += $sample + 2;
		} elseif($biome == Biome::$seasonalForest) {
			$treesAmount += $sample + 1;
		} elseif($biome == Biome::$taiga) {
			$treesAmount += $sample + 1;
		} elseif($biome == Biome::$desert) {
			$treesAmount -= 20;
		} elseif($biome == Biome::$tundra) {
			$treesAmount -= 20;
		} elseif($biome == Biome::$plains) {
			$treesAmount -= 20;
		}
