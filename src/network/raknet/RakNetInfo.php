...
abstract class RakNetInfo{
	...
	const RELIABILITY_UNRELIABLE = 0;
	const RELIABILITY_UNRELIABLE_SEQUENCED = 1;
	const RELIABILITY_RELIABLE = 2;
	const RELIABILITY_RELIABLE_ORDERED = 3;
	const RELIABILITY_RELIABLE_SEQUENCED = 4;
	const RELIABILITY_UNRELIABLE_WITHACKRECEIPT = 5;
	const RELIABILITY_RELIABLE_WITHACKRECEIPT = 6;
	const RELIABILITY_RELIABLE_ORDERED_WITHACKRECEIPT = 7;
