...
class TaskTempt extends TaskBase
{
	...
	public function onUpdate(EntityAI $ai)
	{
		...
		//TODO fix $ai->mobController->moveTo($this->target->x - 0.5, floor($ai->entity->y), $this->target->z - 0.5, false);
		$ai->mobController->lookOn($this->target);
	}

	public function canBeExecuted(EntityAI $ai)
	{
		if(!($ai->entity instanceof Breedable) || $ai->entity->inPanic || $ai->isStarted("TaskMate")){
			return false;
		}
